...
###########################################################################################
# parameter
parser = ArgumentParser(description='heartMRI-CGPD-CSNet-Cartesian-togetherr')
parser.add_argument('--net_name', type=str, default='heartMRI-CGPD-CSNet-Cartesian-together', help='name of net')
parser.add_argument('--start_epoch', type=int, default=0, help='epoch number of start training')
parser.add_argument('--end_epoch', type=int, default=500, help='epoch number of end training')
parser.add_argument('--data_percent', type=float, default=1, help='percent of data')
...
parser.add_argument('--cs_ratio', type=int, default=10,
...
parser.add_argument('--matrix_dir', type=str, default='Cartesian',
                    help='sampling matrix directory, pseudo-radial/2D-random/Cartesian')
...
parser.add_argument('--test_name', type=str, default='heart_test',
...
###########################################################################################
batch_size = 1
Training_data_Name1 = 'Training_heart1.mat'
Training_data1 = sio.loadmat('./%s/%s' % (args.data_dir, Training_data_Name1))
Training_labels = Training_data1['labels']
Training_data_Name2 = 'Training_heart2.mat'
Training_data2 = sio.loadmat('./%s/%s' % (args.data_dir, Training_data_Name2))
Training_labels_tmp = Training_data2['labels']
Training_labels = np.concatenate((Training_labels, Training_labels_tmp))
nrtrain_all = Training_labels.shape[0]   # number of training image
nrtrain = int(args.data_percent * nrtrain_all)
print('Total data number=',nrtrain_all)
print('Training data percent =',args.data_percent)
print('Training data =',nrtrain)
